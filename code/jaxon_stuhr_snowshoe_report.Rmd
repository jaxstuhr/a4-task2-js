...
(((add analyses and Cohens D calculation)))

### Relationship between juvenile weight & hind foot length

```{r}
ggplot(juv_bonanza_hares, aes(x = hindft, y = weight, color = sex)) +
  geom_point() + 
  theme_light() + 
  labs(x = "Hind foot length [mm]", y = "Weight [g]") + 
  scale_color_manual(labels = c("Female", "Male", "NA"), values = c("red", "dark blue"))
```

Fig 3: Juvenile Hare Weights [g] as a function of hind foot length [mm] at three Bonanza sites hares trapped between 1999 and 2012
